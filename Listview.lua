TbdWidgetsListviewMixin = {}

function TbdWidgetsListviewMixin:OnLoad()
...
function TbdWidgetsListviewMixin:OnElementInitialize(element, elementData, isNew)
    if isNew then
        element:OnLoad();
    end
    local height = self.elementHeight;
...
function TbdWidgetsListviewMixin:OnElementReset(element)
